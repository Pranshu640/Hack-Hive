...
const ProjectDetails = () => {
  ...
  const handleRegenerateRoadmap = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/v1/gemini/generate-roadmap`,
        { idea },
  ...
  useEffect(() => {
    const fetchProjectDetails = async () => {
      ...
      try {
        ...
        const projectResponse = await axios.get(`${import.meta.env.VITE_API_URL}/api/v1/projects/team`,
          { headers: { Authorization: `Bearer ${token}` }}
        );
        ...
        await axios.post(`${import.meta.env.VITE_API_URL}/api/v1/projects`,
          { 
            ...idea,
